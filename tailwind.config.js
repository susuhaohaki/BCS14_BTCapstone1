  ...
  theme: {
    extend: {
      boxShadow: {
        ...
        "solid-4":
          "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(8, 14, 40, 0.1) 0px 6px 90px 0px",
        "solid-8":
        ...
        three:
          "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(8, 14, 40, 0.04) 0px 6px 90px 0px",
      },
      backgroundColor: {
        primary: "#006bff",
        dark: "#181c31",
